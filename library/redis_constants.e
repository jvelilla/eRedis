...
feature -- Commands
	...
	CONFIG_GET_Command, CONFIG_SET_Command, CONFIG_RESETSTAT_Command: STRING = "CONFIG"

	DEBUG_OBJECT_Command, DEBUG_SEGFAULT_Command: STRING = "DEBUG"
	...
	Redis_commands: ARRAY [STRING]
		...
		once
			Result := <<set_command, get_command, mget_command, mset_command,
						flush_db_command, flush_all_command, exists_command,
						del_command, type_command, keys_command, rename_command,
						dbsize_command, select_command, quit_command, ttl_command,
						expire_command, persist_command, move_command, rpush_command,
						lpush_command, llen_command, lrange_command, ltrim_command,
						lindex_command, lset_command, lrem_command, rpop_command,
						lpop_command, sadd_command, srem_command, spop_command,
						scard_command, sismember_command, sinter_command,
						smove_command, sinterstore_command, sunion_command,
						sunionstore_command, sdiff_command, sdiffstore_command,
						smembers_command, srandmember_command, blpop_command,
						brpop_command, rpoplpush_command, randomkey_command,
						getset_command, setnx_command, setex_command, msetnx_command,
						incr_command, incrby_command, decr_command, decrby_command,
						append_command, substr_command, zadd_command, zrem_command,
						zincrby_command, zrank_command, zrevrank_command, zrange_command,
						zrevrange_command, zrangebyscore_command, zcount_command,
						zcard_command, zscore_command, zremrangebyrank_command,
						zremrangebyscore_command, zunionstore_command, zinterstore_command,
						hset_command, hget_command, hsetnx_command, hmset_command,
						hmget_commmand, hincrby_command, hexists_command,
						hdel_command, hlen_command, hgetall_command, hkeys_command,
						hvals_command, info_command, renamenx_command, echo_command,
						ping_command, auth_command, bgrewriteaof_command, bgsave_command,
						config_get_command, config_set_command, config_resetstat_command,
						debug_object_command, debug_segfault_command, lastsave_command,
						save_command, shutdown_command, slaveof_command>>
		end
